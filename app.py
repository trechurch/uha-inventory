...
v1.1 — removed external st.image() call that caused raw HTML injection in sidebar
"""
...
def main():
    with st.sidebar:
        # ── Removed st.image() with external URL — caused raw HTML injection
        #    on Streamlit Community Cloud when the remote host was unreachable.
